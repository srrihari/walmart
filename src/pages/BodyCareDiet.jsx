...
export default function BodyCareDiet() {
  ...
  const handleProductClick = (productId) => {
    navigate(`/product/body_care_diet/${productId}`);
  };
  ...
  useEffect(() => {
    ...
    const query = categoryParam
      ...
      : "";
    axios
      .get(`http://localhost:3000/bodycarediet?${query}page=${page}&limit=100`)
      .then((res) => {
        setProducts((prev) =>
