...
export default function SchoolUtensils() {
  ...
  const handleProductClick = (productId) => {
    navigate(`/product/school_utensils/${productId}`);
  };
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://localhost:3000/schoolutensils?${query}page=${page}&limit=100`
      )
      .then((res) => {
        setProducts((prev) =>
          ...
          return (
            ...
            >
              <ProductCard
                ...
                savings={
                  product.original_price
                    ? `Rs.${(product.original_price - product.price).toFixed(
                        2
                      )}`
                    : undefined
                }
