...
export default function FoodGroceries() {
  ...
  // Add to cart function (same as in Electronics)
  ...
  const handleProductClick = (productId) => {
    navigate(`/product/Groceries/${productId}`);
  };
  ...
  useEffect(() => {
    ...
    const query = categoryParam
      ...
      : "";
    axios
      .get(`http://localhost:3000/foodgroceries?${query}page=${page}&limit=100`)
      .then((res) => {
        setProducts((prev) =>
